...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spacecat/AutonomousFlight/simulation/simulation_ws/install/${idir}'.  Ask the maintainer 'Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()
