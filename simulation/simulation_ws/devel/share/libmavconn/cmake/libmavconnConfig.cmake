...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/devel)
  ...
  set(libmavconn_INSTALL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/install)
...
if(NOT "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/indigo/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/mavros/libmavconn/include;/usr/include;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/mavros/libmavconn/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
