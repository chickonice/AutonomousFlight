...
if("TRUE" STREQUAL "TRUE")
  set(rotors_model_SOURCE_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_model)
  set(rotors_model_DEVEL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/devel)
  ...
  set(rotors_model_INSTALL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/install)
...
if(NOT "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_model/include;/usr/include/eigen3 " STREQUAL " ")
  set(rotors_model_INCLUDE_DIRS "")
  set(_include_dirs "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_model/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_model' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_model/${idir}'.  Ask the maintainer 'Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()
