...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/devel)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/spacecat/AutonomousFlight/simulation/simulation_ws/install)
...
if(NOT "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spacecat/AutonomousFlight/simulation/simulation_ws/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  Ask the maintainer 'Markus Achtelik <markus.achtelik_devel@mavt.ethz.ch>' to fix it.")
    endif()
