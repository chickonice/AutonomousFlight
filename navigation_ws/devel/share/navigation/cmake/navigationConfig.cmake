...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/odroid/Documents/ROS/navigation_ws/src/navigation)
  set(navigation_DEVEL_PREFIX /home/odroid/Documents/ROS/navigation_ws/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/odroid/Documents/ROS/navigation_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/Documents/ROS/navigation_ws/src/navigation/${idir}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/odroid/Documents/ROS/navigation_ws/devel/lib;/opt/ros/indigo/lib)
