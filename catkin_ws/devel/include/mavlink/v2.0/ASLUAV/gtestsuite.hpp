...
TEST(ASLUAV, FW_SOARING_DATA)
{
    ...
    packet_in.CurrentUpdraftSpeed = 129.0;
    packet_in.xW = 157.0;
    packet_in.xR = 185.0;
    packet_in.xLat = 213.0;
    packet_in.xLon = 241.0;
    packet_in.VarW = 269.0;
    packet_in.VarR = 297.0;
    packet_in.VarLat = 325.0;
    packet_in.VarLon = 353.0;
    packet_in.LoiterRadius = 381.0;
    packet_in.ControlMode = 173;
    packet_in.valid = 240;
    ...
    EXPECT_EQ(packet1.CurrentUpdraftSpeed, packet2.CurrentUpdraftSpeed);
...
TEST(ASLUAV_interop, FW_SOARING_DATA)
{
    ...
    EXPECT_EQ(packet_in.CurrentUpdraftSpeed, packet2.CurrentUpdraftSpeed);
