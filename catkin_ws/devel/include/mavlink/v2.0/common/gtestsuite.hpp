...
TEST(common, SYS_STATUS)
{
    ...
    packet_in.battery_remaining = 95;
...
TEST(common_interop, SYS_STATUS)
{
    ...
    mavlink_sys_status_t packet_c {
         963497464, 963497672, 963497880, 17859, 17963, 18067, 18171, 18275, 18379, 18483, 18587, 18691, 95
    };
...
TEST(common, CHANGE_OPERATOR_CONTROL)
{
    ...
    packet_in.passkey = make_str_array(packet_in.passkey, "DEFGHIJKLMNOPQRSTUVWXYZA");
...
TEST(common, AUTH_KEY)
{
    ...
    packet_in.key = make_str_array(packet_in.key, "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDE");
...
TEST(common, PARAM_REQUEST_READ)
{
    ...
    packet_in.param_id = make_str_array(packet_in.param_id, "EFGHIJKLMNOPQRS");
...
TEST(common, PARAM_VALUE)
{
    ...
    packet_in.param_id = make_str_array(packet_in.param_id, "IJKLMNOPQRSTUVW");
...
TEST(common, PARAM_SET)
{
    ...
    packet_in.param_id = make_str_array(packet_in.param_id, "GHIJKLMNOPQRSTU");
    packet_in.param_value = 17.0;
...
TEST(common, PARAM_MAP_RC)
{
    ...
    packet_in.param_id = make_str_array(packet_in.param_id, "UVWXYZABCDEFGHI");
...
TEST(common, ADSB_VEHICLE)
{
    ...
    packet_in.callsign = make_str_array(packet_in.callsign, "BCDEFGHI");
...
TEST(common, DEBUG_VECT)
{
    ...
    packet_in.name = make_str_array(packet_in.name, "UVWXYZABC");
    packet_in.time_usec = 93372036854775807ULL;
    packet_in.x = 73.0;
    packet_in.y = 101.0;
    packet_in.z = 129.0;
...
TEST(common, NAMED_VALUE_FLOAT)
{
    ...
    packet_in.time_boot_ms = 963497464;
    packet_in.name = make_str_array(packet_in.name, "IJKLMNOPQ");
...
TEST(common, STATUSTEXT)
{
    ...
    packet_in.text = make_str_array(packet_in.text, "BCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWX");
