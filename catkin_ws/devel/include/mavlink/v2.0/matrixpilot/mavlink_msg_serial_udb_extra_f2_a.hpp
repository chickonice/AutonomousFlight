...
struct SERIAL_UDB_EXTRA_F2_A : mavlink::Message {
    ...
    inline std::string to_yaml(void) const override
    {
        ...
        ss << "  sue_voltage_milis: " << sue_voltage_milis << std::endl;
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << sue_voltage_milis;             // offset: 42
        map << sue_air_speed_3DIMU;           // offset: 44
        map << sue_estimated_wind_0;          // offset: 46
        map << sue_estimated_wind_1;          // offset: 48
        map << sue_estimated_wind_2;          // offset: 50
        map << sue_magFieldEarth0;            // offset: 52
        map << sue_magFieldEarth1;            // offset: 54
        map << sue_magFieldEarth2;            // offset: 56
        map << sue_svs;                       // offset: 58
        map << sue_hdop;                      // offset: 60
        map << sue_status;                    // offset: 62
    }
