...
TEST(matrixpilot, FLEXIFUNCTION_BUFFER_FUNCTION)
{
    ...
    packet_in.data = {{ 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210 }};
...
TEST(matrixpilot, FLEXIFUNCTION_DIRECTORY)
{
    ...
    packet_in.count = 17;
    packet_in.directory_data = {{ 84, 85, 86, 87, 88, 89, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131 }};
...
TEST(matrixpilot, SERIAL_UDB_EXTRA_F2_A)
{
    ...
    packet_in.sue_voltage_milis = 19419;
    packet_in.sue_air_speed_3DIMU = 19523;
    packet_in.sue_estimated_wind_0 = 19627;
    packet_in.sue_estimated_wind_1 = 19731;
    packet_in.sue_estimated_wind_2 = 19835;
    packet_in.sue_magFieldEarth0 = 19939;
    packet_in.sue_magFieldEarth1 = 20043;
    packet_in.sue_magFieldEarth2 = 20147;
    packet_in.sue_svs = 20251;
    packet_in.sue_hdop = 20355;
    ...
    EXPECT_EQ(packet1.sue_voltage_milis, packet2.sue_voltage_milis);
...
TEST(matrixpilot_interop, SERIAL_UDB_EXTRA_F2_A)
{
    ...
    EXPECT_EQ(packet_in.sue_voltage_milis, packet2.sue_voltage_milis);
...
TEST(matrixpilot, SERIAL_UDB_EXTRA_F2_B)
{
    ...
    packet_in.sue_time = 963497464;
    packet_in.sue_pwm_input_1 = 17651;
    packet_in.sue_pwm_input_2 = 17755;
    packet_in.sue_pwm_input_3 = 17859;
    packet_in.sue_pwm_input_4 = 17963;
    packet_in.sue_pwm_input_5 = 18067;
    packet_in.sue_pwm_input_6 = 18171;
    packet_in.sue_pwm_input_7 = 18275;
    packet_in.sue_pwm_input_8 = 18379;
    packet_in.sue_pwm_input_9 = 18483;
    packet_in.sue_pwm_input_10 = 18587;
    packet_in.sue_pwm_output_1 = 18691;
    packet_in.sue_pwm_output_2 = 18795;
    packet_in.sue_pwm_output_3 = 18899;
    packet_in.sue_pwm_output_4 = 19003;
    packet_in.sue_pwm_output_5 = 19107;
    packet_in.sue_pwm_output_6 = 19211;
    packet_in.sue_pwm_output_7 = 19315;
    packet_in.sue_pwm_output_8 = 19419;
    packet_in.sue_pwm_output_9 = 19523;
    packet_in.sue_pwm_output_10 = 19627;
    packet_in.sue_imu_location_x = 19731;
    packet_in.sue_imu_location_y = 19835;
    packet_in.sue_imu_location_z = 19939;
    packet_in.sue_flags = 963497672;
    packet_in.sue_osc_fails = 20043;
    packet_in.sue_imu_velocity_x = 20147;
    packet_in.sue_imu_velocity_y = 20251;
    packet_in.sue_imu_velocity_z = 20355;
    packet_in.sue_waypoint_goal_x = 20459;
    packet_in.sue_waypoint_goal_y = 20563;
    packet_in.sue_waypoint_goal_z = 20667;
    packet_in.sue_memory_stack_free = 20771;
...
TEST(matrixpilot, SERIAL_UDB_EXTRA_F5)
{
    ...
    packet_in.sue_YAW_STABILIZATION_AILERON = 129.0;
    packet_in.sue_AILERON_BOOST = 157.0;
    ...
    EXPECT_EQ(packet1.sue_YAW_STABILIZATION_AILERON, packet2.sue_YAW_STABILIZATION_AILERON);
    EXPECT_EQ(packet1.sue_AILERON_BOOST, packet2.sue_AILERON_BOOST);
}
...
TEST(matrixpilot_interop, SERIAL_UDB_EXTRA_F5)
{
    ...
    EXPECT_EQ(packet_in.sue_YAW_STABILIZATION_AILERON, packet2.sue_YAW_STABILIZATION_AILERON);
    EXPECT_EQ(packet_in.sue_AILERON_BOOST, packet2.sue_AILERON_BOOST);
