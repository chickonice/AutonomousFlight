...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/Documents/AutonomousFlight/apriltags_ws/install/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/odroid/Documents/AutonomousFlight/apriltags_ws/install/lib;/opt/ros/indigo/lib)
